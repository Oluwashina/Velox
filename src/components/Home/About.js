                                 ...
                                 <div className="">
                                    ...
                                    <div className="about-links">
                                        <div className="private">
                                            ...
                                            <a target="_blank"  rel="noreferrer" className="private" href="https://online.myvelox.io/auth/sign-up">
                                                GET STARTED
                            ...
                            <div className="about-card">
                                    ...
                                    <div className="about-links">
                                        ...
                                        <div className="public">
                                          <a target="_blank"  rel="noreferrer" className="public" href="https://online.myvelox.io/auth/sign-up">
                                                GET STARTED
                            ...
                            <div className="col-lg-4">
                                ...
                                <div className="about-links">
                                    ...
                                    <div className="student">
                                        <a target="_blank"  rel="noreferrer" className="student" href="https://online.myvelox.io/auth/sign-up">
                                                GET STARTED
